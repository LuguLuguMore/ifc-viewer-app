...
class IfcViewer:
    def __init__(self, master):
        ...
        self.properties_frame.pack(side=tk.LEFT, fill=tk.BOTH, expand=True)
        ...
        self.pset_frame.pack(side=tk.LEFT, fill=tk.BOTH, expand=True)
        ...
        # Create a canvas for embedding Matplotlib plots in Tkinter
        self.canvas = FigureCanvasTkAgg(self.network_graph_plot(), master=self.graph_frame)
        self.canvas.draw()
    ...
    def show_properties(self, event):
        ...
        if selected_item:
            ...
            self.update_network_graph(selected_element)
    ...
    def update_network_graph(self, selected_element):
        ...
        self.canvas.figure = self.network_graph_plot()
        self.canvas.draw()
